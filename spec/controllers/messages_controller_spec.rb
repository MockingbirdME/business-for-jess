...
RSpec.describe MessagesController, type: :controller do
  ...
  describe "Post create" do
    it "increases the number of messages by one" do
      expect{post :create, message:{body:"new message body", response_name: "steven king", response_email: "steve@royalty.come", response_phone:"555-555-5555"}}.to change(Message, :count).by(1)
    end
    it "assigns the new message to @message" do
      post :create, message:{body:"new message body", response_name: "steven king", response_email: "steve@royalty.come", response_phone:"555-555-5555"}
